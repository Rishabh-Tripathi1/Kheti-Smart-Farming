...
mongoose.connect( "mongodb+srv://test:test1357924680@farming-assisstant.z38uqhw.mongodb.net/?retryWrites=true&w=majority", {
...
app.get("/next", function(req, res) {
  // Redirect to another localhost server on port 3000 
